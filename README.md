...
This is the **paper** ground -- the same three inks printing dark on a
...
15.59) and needed its own solved set. Siblings: [Overprint](https://github.com/slhuckstead/omarchy-overprint-theme)
and [Overprint Slate](https://github.com/slhuckstead/omarchy-overprint-slate-theme).
